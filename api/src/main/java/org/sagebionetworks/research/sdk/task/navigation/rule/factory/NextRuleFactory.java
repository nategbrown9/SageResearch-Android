...
public class NextRuleFactory implements NavigationRuleFactory<NavigationRule.Next>{
    private static final Logger LOGGER = LoggerFactory.getLogger(NextRuleFactory.class);

    @Nullable
    @Override
    public NavigationRule.Next create(@NonNull Step step) {
        checkNotNull(step);

        NavigationRule.Next rule = null;
